...
sectoral_ref_damage <- emisinoutpopgdp %>%
...
state_year_sectoral_ref_damage <- create_state_year_sectoral(sectoral_data = sectoral_ref_damage,
                                                             states = c("AK", "CA", "NY"),
                                                             years = c(2035, 2050),
...
create_state_year_specific_sectoral_plot(state_year_sectoral_data = state_year_sectoral_ref_damage,
                                         state = "AK",
                                         year = 2035, 
                                         ghg = "NOx")
```
...
create_and_save_plots(state_year_sectoral_ref_damage,
                                  emission_type = "NOx",
