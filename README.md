...
-   `Population_by_region.csv` : This file is identical to the raw file generated by the *Population-by-state* query in the ModelInterface, except for the addition of three damage function scenarios data.

-   `GDP_per_capita_PPP_by_region.csv` : This file is also identical to the raw file generated by the *GDP-per-capita-by-state* query in the ModelInterface, except for the addition of three damage function scenarios data.
